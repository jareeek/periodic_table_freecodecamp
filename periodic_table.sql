...
--
-- Name: properties fk_type_id_properties; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_type_id_properties FOREIGN KEY (type_id) REFERENCES public.types(type_id);
